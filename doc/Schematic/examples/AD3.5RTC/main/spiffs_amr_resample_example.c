...
void record_playback_task()
{
    ...
    uint8_t cont = 0;
    uint8_t sound_recording_laststatus = 0;
    extern uint8_t sound_recording_status;
    // uint8_t sound_recording_status = 0;

    while (1)
    {
        if (sound_recording_status == sound_recording_laststatus)
        {
        ...
        {
            sound_recording_laststatus = sound_recording_status;
        }
        // if (cont == 0)
        // {
        ...
        else if (sound_recording_status == 2)
        {
