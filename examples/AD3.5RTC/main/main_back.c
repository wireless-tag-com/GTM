...
void app_main(void)
{
    ...
    // mktp2016_init(BOARD_I2C_SDA_PIN, BOARD_I2C_SCL_PIN);
    // extern void proximity_task(void *param);
    // xTaskCreate(proximity_task, "proximity_task", 4 * 1024, NULL, 5, NULL);
    gui_user_init();
    ...
    // rtc_init();
    //  extern void spiffs_amr_resample(void);
    //  spiffs_amr_resample();
}
#endif